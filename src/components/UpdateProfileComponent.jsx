...
class UpdateProfileComponent extends Component {
    ...
    updateProfile = (e) => {
        if (this.state.emailId === this.state.reTypeEmailId) {
            let profile = {
                id: this.state.id,
            ...
            ProfileService.updateProfiles(profile).then(res => {
                ...
                if (error.code === 'ERR_BAD_REQUEST') {
                    toast.success('Please enter a valid data', { position: 'top-center' });
                }
            })
            history.push(PathConstants.HOME);
        } else {
            alert('Please enter valid and correct mailId')
        }
    };
    cancel() {
        history.push(PathConstants.HOME)
            ...
            <div
                ...
                <div class="w-full">
                    <div class="text-center">
                        <h1 class="text-3xl font-semibold text-gray-900">Update profile</h1>
                        <p class="mt-2 text-gray-500">Enter a vald profile data</p>
                    </div>
                    <div class="mt-5">
                        <form action="">
                        <div class="relative mt-6">
                                ...
                                <label class="pointer-events-none absolute top-0 left-0 origin-left -translate-y-1/2 transform text-sm text-gray-800 opacity-75 transition-all duration-100 ease-in-out peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">
                                    Profile Id</label>
                            </div>
                            <div class="relative mt-6">
                                <input 
...
export default withParams(UpdateProfileComponent);